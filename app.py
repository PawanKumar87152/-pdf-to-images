...
if st.session_state.page == "home":
    ...
    img2pdf()import streamlit as st
...
/* different colors per button using nth-child */
div[data-testid="column"]:nth-child(1) button {
    background: #ef4444;
    color: white;
}
...
def home():
    ...
    st.markdown("<div class='title'>📄 PDF SUITE PRO</div>", unsafe_allow_html=True)
    st.markdown("<div class='sub'>Modern Dark SaaS PDF Tools</div>", unsafe_allow_html=True)
